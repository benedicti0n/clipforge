...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-row items-center justify-center p-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "w-[350px]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { children: [
      "Counter: ",
      counter
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Click on increase / decrease to check the state changes" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardFooter, { className: "flex justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: decrease, variant: "outline", children: "Decrease --" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: increase, children: "Increase ++" })
    ] })
  ] }) });
}
const initialState = {
...
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { defaultTheme: "dark", storageKey: "vite-ui-theme", children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) })
);
